...
import FinalizarEvento from "../FinalizarEventos";

export default function App() {
      const { tab } = useChromeStorage("currentTab");

      const MenuList = [
            {
                  value: "finalizarEventos",
                  icon: <BookCheck />,
                  render: <FinalizarEvento />,
            },
      ];
